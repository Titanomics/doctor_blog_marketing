  ...
  return (
    <aside className="w-72 min-h-screen bg-white border-r border-slate-100 flex flex-col">
      ...
      <div className="px-5 py-5 border-b border-slate-100">
        ...
        <p className="text-xs text-slate-400 mt-0.5">블로그 순위 대시보드</p>
      </div>
        ...
        <AnimatePresence>
          {assigneeFilter === "mine" && (
            <motion.input
              ...
              className="w-full px-3 py-2 text-sm rounded-lg border border-slate-200 focus:border-emerald-400 outline-none text-slate-700 placeholder:text-slate-400"
            />
          )}
        </AnimatePresence>
